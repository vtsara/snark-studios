...
class SiteFooter extends HTMLElement {
    connectedCallback() {
        ...
        <h5>footnotes</h5>
        <div class="inner">
            <p class="fadeup-effect">This site was designed and developed by Snark Studios, obviously. Tech stack simple as a three-ingredient dump cake: html, css, and good ol' vanilla javascript. Long live the classics!</p>
            <div class="socials fadeup-effect">
                ...
                <a href="https://github.com/vtsara" target="_blank">my [noob] github</a>
